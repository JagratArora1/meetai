                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
                            <div className="flex flex-col gap-6">
                                ...
                                <Button disabled={pending} type="submit" className="w-full bg-green-700 hover:bg-green-800 text-white">
                                    Sign Up
                                </Button>
                                ...
                                <div className="text-center text-sm">
                                    Already have an account? <Link href="/sign-in" className="underline underline-offset-4 hover:text-red-700">
                                        Sign In
                                    </Link>
                                </div>                            
                            </div>
