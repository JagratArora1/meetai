                    ...
                    <div className="bg-white rounded-lg border">
                        <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
                            ...
                            <div className="flex gap-x-2 items-center">
                                <Link href={`/agents/${data.agent.id}`} className="flex items-center gap-x-2 underline underline-offset-4 capitalize hover:text-red-700">
                                    <GeneratedAvatar
                            ...
                            <div>
                                <Markdown
                                    components={{
                                        ...
                                        blockquote:(props) => (
                                            <blockquote className="border-l-4 pl-4 italic my-14"{...props} />
                                        ),
                                    }}
                                >
                                    {data.summary}
