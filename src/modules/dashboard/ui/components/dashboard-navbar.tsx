        ...
        <>
            ...
            <nav className="flex px-4 gap-x-2 items-center py-3 border-b bg-background">
                ...
                <Button className="h-9 w-[240px] justify-start font-normal text-muted-foreground hover:text-muted-foreground" variant="outline" size="sm" onClick={()=> setCommandOpen((open) => !open)}>
                    ...
                    Search
                    <kbd className="ml-auto pointers-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground">
